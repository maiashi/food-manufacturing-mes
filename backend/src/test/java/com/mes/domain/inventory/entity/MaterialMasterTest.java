...
class MaterialMasterTest {
    ...
    void fullConstructor_setsAllFields() {
        ...
        MaterialMaster entity = new MaterialMaster(
                ...
                List.of("Gluten"), "Cool and dry", "kg", now
        );
    ...
    void copy_createsNewInstanceWithDifferentId() {
        MaterialMaster original = new MaterialMaster(
                UUID.randomUUID(), "SKU-001", "Sugar", null, false, List.of(), "Dry", "kg", LocalDateTime.now()
        );
    ...
    void equalsAndHashCode_worksViaBaseEntity() {
        ...
        MaterialMaster a = new MaterialMaster(sameId, "A", "Prod A", "X", false, null, "", "", LocalDateTime.now());
        MaterialMaster b = new MaterialMaster(sameId, "B", "Prod B", "Y", true, List.of(), "", "", LocalDateTime.of(2025, 1, 1, 0, 0));
