  ...
  <div class="haccp">
    <div class="page-header">
      ...
      <div class="actions">
        ...
        <el-button type="primary" @click="showAddPlan = true">計画追加</el-button>
      </div>
    </div>
        ...
        <el-table :data="haccpPlans" stripe>
          ...
          <el-table-column prop="haccpType" label="タイプ" width="120">
            <template #default="{ row }">
              <el-tag :type="row.haccpType === 'HACCP_PLAN' ? 'danger' : 'warning'">
                {{ row.haccpType }}
              </el-tag>
            </template>
          </el-table-column>
      ...
      <el-tab-pane label="CCP監視" name="ccp">
        <el-table :data="ccpRecords" stripe>
          ...
          <el-table-column label="規格" width="120">
            <template #default="{ row }">{{ row.minLimit }} ~ {{ row.maxLimit }}</template>
          </el-table-column>
